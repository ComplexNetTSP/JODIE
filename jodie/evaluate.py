...
def evaluate(hyperparameter, data, epoch=50, device="cpu", proportion_train=0.6, state=True, directory="./"):
    ...
    model, optimizer, embedding_dynamic_static_user, embedding_dynamic_static_item, embedding_user_timeserie, embedding_item_timeserie, idx_training = load_model(model, optimizer, epoch-1, device, embedding_dim, learning_rate, split, lambda_u, lambda_i, data, directory)
